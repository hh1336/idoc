...
class FIdConst
{
   ...
   * 文件夹权限
   */
  const WJGL_DIR_ADD = "3001-01";
  const WJGL_DIR_EDIT = "3001-02";
  const WJGL_DIR_CHECK = "3001-03";
  const WJGL_DIR_DEL = "3001-04";
  const WJGL_DIR_INVALID = "3001-05";//作废

  /**
   * 文件权限
   */
  const WJGL_FILE_ADD = "3001-06";
  const WJGL_FILE_EDIT = "3001-07";
  const WJGL_FILE_DEL = "3001-08";
  const WJGL_FILE_CHECK = "3001-09";
  const WJGL_FILE_INVALID = "3001-10";

  /**
   * 操作记录权限
   */
  const WJGL_ACTION_LOG = "3001-11";
